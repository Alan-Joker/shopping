                    ...
                    <ul>
                        <c:forEach items="${pageInfo.list}" var="goods">
                            <li class="data-item-li">
                                <div class="to-big">
                                    <a href="${pageContext.request.contextPath}/detail?goodsId=${goods.goodsid}"> <img src="${pageContext.request.contextPath}/images/${goods.imagePaths[0]}" width="260px" height="260px" alt=""/>
                                    </a>
                                </div>
                                <p class="text-right">
