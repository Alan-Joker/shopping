    ...
    if(goods.length === 0) {
        ...
        $.each(goods, function (index,item) {
            ...
            var shopimage = $("<td></td>").addClass("product-thumbnail product-thumbnail-2")
                .append($("<a></a>").attr("href","/xb//detail?goodsId="+item.goodsid)
                    .append($("<img/>").attr("src","/xb//images/"+item.imagePaths[0])));

            var goodsname = $("<td></td>").addClass("product-name product-name_2")
                .append($("<a></a>").attr("href","/xb/detail?goodsId="+item.goodsid).append(item.goodsname));
